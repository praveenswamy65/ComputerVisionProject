...
fid = fopen('C:\Uppsala\Sem 2\Image analysis 2\Project\v_p_data\Labels_train.txt');
% read labels
...
fid = fopen('C:\Uppsala\Sem 2\Image analysis 2\Project\v_p_data\Labels_test.txt');
% read labels
data = textscan(fid,'%s');true_labels = data{1,1};
% close fopen
fclose(fid);
...
folder = 'C:\Uppsala\Sem 2\Image analysis 2\Project\v_p_data\';
